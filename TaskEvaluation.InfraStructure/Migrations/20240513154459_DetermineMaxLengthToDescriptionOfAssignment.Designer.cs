...
namespace TaskEvaluation.InfraStructure.Migrations
{
    ...
    [Migration("20240513154459_DetermineMaxLengthToDescriptionOfAssignment")]
    partial class DetermineMaxLengthToDescriptionOfAssignment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TasksEvaluation.Core.Entities.Business.Solution", b =>
                {
                    ...
                    b.HasOne("TasksEvaluation.Core.Entities.Business.EvaluationGrade", "EvaluationGrade")
                        .WithOne("Solution")
                        .HasForeignKey("TasksEvaluation.Core.Entities.Business.Solution", "GradeId");
